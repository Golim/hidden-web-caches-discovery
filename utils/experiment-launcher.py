...
def main():
    MAX = 15 # Max number of processes to run at once
    TIMEOUT = 5 # Timeout in minutes
    crawler = 'hidden-web-caches-discovery.py'
    ...
    blacklist = ['google', 'facebook', 'amazon', 'twitter', '.gov', 'acm.com', 'jstor.org', 'arxiv', '.mil']
